...
const messageText = "Sabia que tomaria a decisão certa ❤️";
...
setInterval(function () {
    ...
    // Desenhar a mensagem no centro do canvas
    a.font = "2rem Poppins, sans-serif"; // Ajuste o tamanho e a fonte conforme necessário
    a.fillStyle = "#ff3333"; // Cor neon vermelho
    a.textAlign = "center";
    a.textBaseline = "middle";
    // Adicionar efeito de brilho neon ao texto (opcional, pode impactar performance)
    a.shadowColor = "#ff3333";
    a.shadowBlur = 10;
    a.fillText(messageText, WIDTH / 2, HEIGHT / 2);
    // Resetar shadow blur para não afetar o desenho do coração
    a.shadowBlur = 0;
